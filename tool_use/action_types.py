...
class QuestionRecipe(Protocol):
    async def __call__(self, question: str, context: list) -> str: ...
...
action_types = [
    Action(
        name="Web search",
        description="Run a web search using Google. This is helpful if the question depends on obscure facts or current information, such as the weather, latest news or current population of a country.",
